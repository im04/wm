...
module.exports = {
    ...
    resolve: {
        ...
        alias: {
            ...
            'assets': utils.assetsRootPath('src/assets'),
    ...
    plugins: [
        ...
        new webpack.ProvidePlugin({
            ...
            'tabButtonController':utils.assetsRootPath('src/components/tab/tab-ctr.js'),
            'Vue' : 'vue',
            'http': utils.assetsRootPath('src/config/http-'+process.env.PRO_ENV+'.js'),
            'utils': utils.assetsRootPath('src/assets/script/utils.js'),
        })
    ]
};
