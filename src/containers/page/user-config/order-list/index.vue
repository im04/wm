            ...
            <pagination-content :options="paginationInit" :size-change="handleSizeChange"
                ...
                <template slot="body">
                    <el-table :data="tableInit.dataList" :border="true" size="small">
                        ...
                        <el-table-column prop="name" label="用户账户"/>
                        <el-table-column prop="coin" label="哇币"/>
                        <el-table-column prop="title" label="购买商品"/>
                    </el-table>
                </template>
            </pagination-content>
        </div>
    ...
    export default {
        ...
        methods: {
            getData() {
                ...
                this.$store.dispatch('userList/getOrderList', params
                ).then(function (r) {
