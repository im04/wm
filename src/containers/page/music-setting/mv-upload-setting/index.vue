    ...
    <div>
        ...
        <div class="content">
            <tab-cpt :tab-click="tabClick">
                <template slot="head">
                    <el-button type="primary" @click="tabCallback()" size="small">上传MV</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            tabCallback(target) {
                ...
                _router.push('/musicSetting/mvUploadSetting/mvUploadSettingEdit');
            },
            buttonClick(item) {
                console.log(arguments);
            },
