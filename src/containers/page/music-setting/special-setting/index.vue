    ...
    <div>
        ...
        <div class="content">
            <tab-cpt :tab-click="tabClick">
                <template slot="head">
                    <el-button type="primary" @click="tabCallback()" size="small">添加专辑</el-button>
                    ...
                    <pagination-content :options="paginationInitReleased" :current-change="handleCurrentReleased">
                        <template slot="body">
                            ...
                            <el-table :data="tableReleased" :border="true" size="small">
                                ...
                                <el-table-column prop="date" label="专辑名"/>
                                <el-table-column prop="name" label="专辑id"/>
                                <el-table-column prop="date" label="歌手"/>
                                <el-table-column prop="name" label="地区"/>
                                <el-table-column prop="name" label="音乐类型"/>
                                <el-table-column prop="name" label="单曲"/>
...
<script>
    ...
    export default {
        ...
        beforeCreate() {
            this.$store.dispatch('specialSetting/getData',{
                mid: '1'
            });
...
//            this.$store.dispatch('liveSettingIndex/getTableDraftData');
        ...
        methods: {
            ...
            tabCallback(target) {
                ...
                _router.push('/musicSetting/specialSetting/specialSettingEdit');
            },
            buttonClick(item) {
                console.log(arguments);
            },
