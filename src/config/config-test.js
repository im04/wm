...
// const music_domain = 'http://music.vr-mu.com:8091/group-b';
// const video_domain = 'http://video.vr-mu.com:8091/group-b';
// const user_domain = 'http://user.vr-mu.com:8091/group-b';
// const live_domain = 'http://live.vr-mu.com:8091/group-b';
// const payment_domain = 'http://payment.vr-mu.com:8091/group-b';
// const configs_domain = 'http://configs.vr-mu.com:8091/group-b';

const music_domain = 'http://192.168.30.99:8091/group-b';
const video_domain = 'http://192.168.30.99:8091/group-b';
const user_domain = 'http://192.168.30.99:8091/group-b';
const live_domain = 'http://192.168.30.99:8091/group-b';
const payment_domain = 'http://192.168.30.99:8091/group-b';
const configs_domain = 'http://192.168.30.99:8091/group-b';
    ...
    url: {
        ...
        */
        user: {
            ...
            membersPackage: {//会员套餐
                save: user_domain + '/user/vip/combo/basic/save',//添加/编辑套餐
                delete: user_domain + '/user/vip/combo/basic/delete',//删除套餐
                detail: user_domain + '/user/vip/combo/basic/detail',//套餐详情
                findBy: user_domain + '/user/vip/combo/basic/find-by'//套餐列表
            },
            signInAward: {//签到额外奖励
        ...
        */
        pay: {
            pay: {//哇币套餐
                findBy: payment_domain + '/payment/coin/combo/basic/find-by',//哇币套餐列表
                get: payment_domain + '/payment/coin/combo/basic/get',//哇币套餐详情
                save: payment_domain + '/payment/coin/combo/basic/save',//添加/编辑哇币套餐
                delete: payment_domain + '/payment/coin/combo/basic/delete' // 删除套餐
            },
        },
        /*
        *   配置模块
        */
        config: {
            region: {//地区
                save: configs_domain + '/configs/region/basic/save',//添加/修改地区
                delete: configs_domain + '/configs/region/basic/delete',//删除地区
                detail: configs_domain + '/configs/region/basic/detail',//地区详情
                findBy: configs_domain + '/configs/region/basic/find-by'//地区列表
            },
            theme: {//icon
                save: configs_domain + '/configs/theme/basic/save',//添加/修改icon
                delete: configs_domain + '/configs/theme/basic/delete',//删除icon
                detail: configs_domain + '/configs/theme/basic/detail',//icon详情
                findBy: configs_domain + '/configs/theme/basic/find-by'//icon列表
            },
            activity: {//活动
                save: configs_domain + '/configs/activity/basic/save',//添加/修改活动
                delete: configs_domain + '/configs/activity/basic/delete',//删除活动
                detail: configs_domain + '/configs/activity/basic/detail',//活动详情
                findBy: configs_domain + '/configs/activity/basic/find-by'//活动列表
            },
            banner: {//Banner
                save: configs_domain + '/configs/banner/basic/save',//添加/修改Banner
                delete: configs_domain + '/configs/banner/basic/delete',//删除Banner
                detail: configs_domain + '/configs/banner/basic/get',//Banne详情
                findBy: configs_domain + '/configs/banner/basic/find-by'//Banne列表
            },
            admin: {//管理员
                save: configs_domain + '/configs/admin/basic/save',//添加/修改管理员信息
                delete: configs_domain + '/configs/admin/basic/delete',//删除管理员信息
                detail: configs_domain + '/configs/admin/basic/detail',//查看管理员详情
                findBy: configs_domain + '/configs/admin/basic/find-by'//查询管理员列表
            },
            department: {//部门
                save: configs_domain + '/configs/department/basic/save',//添加/修改部门信息
                delete: configs_domain + '/configs/department/basic/delete',//删除部门信息
                detail: configs_domain + '/configs/department/basic/detail',//查看部门详情
                findBy: configs_domain + '/configs/department/basic/find-by'//查询部门列表
            },
            resourse: {//权限
                save: configs_domain + '/configs/resourse/basic/save',//添加/修改权限信息
                delete: configs_domain + '/configs/resourse/basic/delete',//删除权限信息
                detail: configs_domain + '/configs/resourse/basic/detail',//查看权限详情
                findBy: configs_domain + '/configs/resourse/basic/find-by'//查询权限列表
            },
            menu: {//菜单
                save: configs_domain + '/configs/menu/basic/save',//添加/修改菜单信息
                delete: configs_domain + '/configs/menu/basic/delete',//删除菜单信息
                detail: configs_domain + '/configs/menu/basic/detail',//查看菜单详情
                findBy: configs_domain + '/configs/menu/basic/find-by'//查询菜单列表
            }
        },
