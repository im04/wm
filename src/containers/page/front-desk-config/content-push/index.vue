    ...
    <div>
        <search-header :options="searchInit" :click-callback="clickCallback" :button-callback="buttonClick">
            <div class="search-bar bg-white child-middle">
                <span>搜索选项 : </span>
                <el-input  placeholder="内容关键词" class="repeat-el-input" ></el-input>
        ...
        <div class="content">
            <tab-cpt :options="tabInit" :tab-click="tabClick">
                <template slot="head">
                    <el-button type="primary" @click="tabCallback()" size="small">新建消息</el-button>
                </template>
                <div tit="数据列表" name="0">
                    <pagination-content :options="paginationInit" :size-change="handleSizeChange" :current-change="handleCurrentChange">
                        <template slot="body">
                            ...
                            <el-table :data="tableInit.dataList" :border="true" size="small">
                                ...
                                <el-table-column prop="date" label="发布人"/>
                            </el-table>
                        </template>
                    </pagination-content>
                </div>
    ...
    export default {
        ...
        methods: {
            tabCallback(target) {
                ...
                _router.push('/frontDeskConfig/contentPush/contentPushEdit');
            },
            buttonClick(item) {
