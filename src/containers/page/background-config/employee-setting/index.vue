    ...
    <div>
        <search-header :options="searchInit" :click-callback="clickCallback" :button-callback="buttonClick">
            <div class="search-bar bg-white child-middle">
                <span>搜索选项 : </span>
                <el-input  placeholder="姓名" class="repeat-el-input" ></el-input>
                <el-input  placeholder="所属部门" class="repeat-el-input" ></el-input>
        ...
        <div class="content">
            <tab-cpt :options="tabInit" :tab-click="tabClick">
                <template slot="head">
                    <el-button type="primary" @click="tabCallback()" size="small">添加成员</el-button>
                </template>
                <div tit="数据列表" name="0">
    ...
    export default {
        ...
        methods: {
            tabCallback(target) {
                ...
                _router.push('/backgroundConfig/employeeSetting/employeeSettingEdit');
            },
            buttonClick(item) {
