    ...
    <div class="edit-page-content m-top-30">
        <edit-block class="has-input-max" title="基本信息">
            <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                <two-cell>
                    <el-form-item slot="left" label="直播厅名" prop="title">
                        <el-input v-model="form.title" placeholder="请输入名称"></el-input>
                    </el-form-item>
                    <el-form-item slot="right" label="id" prop="type">
                        <span>748383293</span>
                    </el-form-item>
                </two-cell>
        ...
        <edit-block class="has-input-max" title="机位管理">
            <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                <div class="m-bottom-22 ov-hi">
                    <el-button class="fr">添加</el-button>
                </div>
                <el-table :data="tableInit.dataList">
                    <el-table-column prop="date" label="机位名称"/>
                    <el-table-column prop="date" label="机位类型"/>
