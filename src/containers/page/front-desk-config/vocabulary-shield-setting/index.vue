    ...
    <div>
        <search-header :options="searchInit" :click-callback="clickCallback" :button-callback="buttonClick">
            <div class="search-bar bg-white child-middle">
                <span>搜索选项 : </span>
                <el-input  placeholder="词汇" class="repeat-el-input" ></el-input>
        ...
        <div class="content">
            <tab-cpt :options="tabInit" :tab-click="tabClick">
                <template slot="head">
                    <el-button type="primary" @click="tabCallback()" size="small">添加屏蔽词</el-button>
                    <el-button @click="tabCallback()" size="small">批量导入</el-button>
                </template>
                <div tit="数据列表" name="0">
                    <pagination-content :options="paginationInit" :size-change="handleSizeChange" :current-change="handleCurrentChange">
                        <template slot="body">
                            ...
                            <el-table :data="tableInit.dataList" :border="true" size="small">
                                ...
                                <el-table-column prop="date" label="屏蔽词汇"/>
                        ...
                        <template slot="floor">
                            <el-button :plain="true" class="btn" size="small">批量删除</el-button>
                        </template>
                    </pagination-content>
                </div>
            </tab-cpt>
    ...
    export default {
        ...
        methods: {
            tabCallback(target) {
                ...
                _router.push('/frontDeskConfig/keyWorldSetting/keyWorldSettingEdit');
            },
            buttonClick(item) {
