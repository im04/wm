    ...
    <div>
        <search-header :options="searchInit" :click-callback="clickCallback" :button-callback="buttonClick">
            <div class="search-bar bg-white child-middle">
                <span>搜索选项 : </span>
                <el-input  placeholder="部门名称" class="repeat-el-input" ></el-input>
        ...
        <div class="content">
            <tab-cpt :options="tabInit" :tab-click="tabClick">
                <template slot="head">
                    <el-button type="primary" @click="tabCallback()" size="small">添加部门</el-button>
                </template>
                <div tit="数据列表" name="0">
                    <pagination-content :options="paginationInit" :size-change="handleSizeChange" :current-change="handleCurrentChange">
                        <template slot="body">
                            ...
                            <el-table :data="tableInit.dataList" :border="true" size="small">
                                ...
                                <el-table-column prop="date" label="职能描述"/>
                                <el-table-column prop="date" label="成员数量"/>
    ...
    export default {
        ...
        methods: {
            tabCallback(target) {
                ...
                _router.push('/backgroundConfig/departmentSetting/departmentSettingEdit');
            },
            buttonClick(item) {
